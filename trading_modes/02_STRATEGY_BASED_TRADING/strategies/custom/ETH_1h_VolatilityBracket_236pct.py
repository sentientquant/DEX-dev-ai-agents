...
class Strategy(BaseStrategy):
    ...
    target_pair = "ETHUSDT"  # Standardized: full pair format
    target_timeframe = "1h"
    ...
    def __init__(self):
        super().__init__(name="VolatilityBracket_ETH_1h")
        self.prev_sma = None
    ...
    def generate_signals(self, symbol: str, ohlcv: pd.DataFrame) -> dict:
        ...
        try:
            ...
            # This is the CORRECT formula that produced 236% backtest returns
