...
# CRYPTO MARKETS ARE INCLUDED - We want crypto sentiment!
IGNORE_CRYPTO_KEYWORDS = []  # Empty - we WANT crypto markets!

# Sports markets are EXCLUDED - Not relevant for crypto trading
