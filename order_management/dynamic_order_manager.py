...
class DynamicOrderManager:
    ...
    def _calculate_take_profits(
        ...
        rr_ratios = {
            MarketRegime.TRENDING_UP: [1.5, 2.0, 3.0],  # TP1: 1.5x, TP2: 2x, TP3: 3x
        ...
        base_rr = rr_ratios.get(regime, [1.5, 2.0, 3.0])
        ...
        if momentum_strength == MomentumStrength.VERY_STRONG:
            ...
            rr_multiplier = 0.90  # Less conservative
        elif momentum_strength == MomentumStrength.VERY_WEAK:
            rr_multiplier = 0.80  # Less conservative
        else:
            rr_multiplier = 1.0
