...
# Model Configurations (FIXED - using valid OpenRouter model IDs)
# You can switch between "deepseek", "openrouter", "openai", "claude", "groq", etc.
# Available xAI models via OpenRouter: x-ai/grok-code-fast-1 (best for coding!), x-ai/grok-4-fast,
#                                       x-ai/grok-4-07-09, x-ai/grok-3, x-ai/grok-3-mini
RESEARCH_CONFIG = {
    "type": "openrouter",  # Using Grok Code Fast via OpenRouter (optimized for coding!)
    "name": "x-ai/grok-code-fast-1"
}

BACKTEST_CONFIG = {
    "type": "openrouter",  # Using Grok Code Fast via OpenRouter for backtest coding
    "name": "x-ai/grok-code-fast-1"
}

DEBUG_CONFIG = {
    "type": "openrouter",  # Using Grok Code Fast via OpenRouter for debugging
    "name": "x-ai/grok-code-fast-1"
}

PACKAGE_CONFIG = {
    "type": "openrouter",  # Using Grok Code Fast via OpenRouter for package checking
    "name": "x-ai/grok-code-fast-1"
}

OPTIMIZE_CONFIG = {
    "type": "openrouter",  # Using Grok Code Fast via OpenRouter for optimization
    "name": "x-ai/grok-code-fast-1"
}
