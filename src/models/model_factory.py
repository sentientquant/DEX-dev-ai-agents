...
class ModelFactory:
    ...
    MODEL_IMPLEMENTATIONS = {
        "claude": ClaudeModel,
        "groq": GroqModel,
        # "openai": OpenAIModel,  # DISABLED - Not used in hybrid config, has Unicode issues
    ...
    def _get_api_key_mapping(self) -> Dict[str, str]:
        ...
        return {
            ...
            "groq": "GROQ_API_KEY",
            # "openai": "OPENAI_KEY",  # DISABLED - Not used in hybrid config, has Unicode issues
            "gemini": "GEMINI_KEY",  # Re-enabled with Gemini 2.5 models
            "deepseek": "DEEPSEEK_KEY",
            "xai": "GROK_API_KEY",  # Grok/xAI uses GROK_API_KEY
            "openrouter": "OPENROUTER_API_KEY",  # Re-enabled for hybrid swarm
