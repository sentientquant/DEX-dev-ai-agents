...
class StochasticHarmony(Strategy):
    ...
    def init(self):
        ...
        self.stochrsi, self.k, self.d = self.I(talib.STOCHRSI, self.data.Close, timeperiod=14, fastk_period=14, fastd_period=3)
                            ...
                            if bull_cross and oversold and not self.position:
                                ...
                                if risk > 0:
                                    ...
                                    if size > 0:
                                        ...
                                        print(f"🌙 Moon Dev: Bullish Gartley Detected! LONG entry at {entry:.2f}, SL: {sl:.2f}, TP: {tp:.2f}, Size: {size} 🚀✨")
                            ...
                            if bear_cross and overbought and not self.position:
                                ...
                                if risk > 0:
                                    ...
                                    if size > 0:
                                        ...
                                        print(f"🌙 Moon Dev: Bearish Gartley Detected! SHORT entry at {entry:.2f}, SL: {sl:.2f}, TP: {tp:.2f}, Size: {size} 🚀✨")
